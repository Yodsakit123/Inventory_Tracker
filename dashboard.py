...
# 1. The Data
# Fake production numbers for two machines over a 7-day period
data = {
...
def update_graph(selected_machine):
    # Filter the dataframe based on the selected machine
    if selected_machine == 'All':
        filtered_df = df
        title = 'Production Over Time: All Machines'
        color = 'Machine'  # Group by machine using colors
    else:
